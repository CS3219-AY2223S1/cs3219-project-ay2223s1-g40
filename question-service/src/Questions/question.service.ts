...
export class QuestionService {
  ...
  async getDifficultyQuestion(QuestionDifficulty: string): Promise<QuestionDocument> {
    const existingQuestions = await this.QuestionModel.find({ difficulty : QuestionDifficulty}).exec();
